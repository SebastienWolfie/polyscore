...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/icon/ico/polyscore/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/icon/ico/polyscore/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/icon/ico/polyscore/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/icon/ico/polyscore/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/icon/ico/polyscore/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/icon/ico/polyscore/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/icon/ico/polyscore/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/icon/ico/polyscore/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/icon/ico/polyscore/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/icon/ico/polyscore/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/icon/ico/polyscore/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/icon/ico/polyscore/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/icon/ico/polyscore/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/icon/ico/polyscore/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/icon/ico/polyscore/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/icon/ico/polyscore/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/icon/ico/polyscore/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/icon/ico/polyscore/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/icon/ico/polyscore/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/icon/ico/polyscore","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/icon/ico/polyscore/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/icon/ico/polyscore/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/icon/ico/polyscore/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/icon/ico/polyscore/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _R7RzB5SOhH = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/icon/ico/polyscore";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _5r38XyCtgs = (nitroApp) => {
...
const getClientManifest = () => import('file:///Users/icon/ico/polyscore/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/icon/ico/polyscore/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
